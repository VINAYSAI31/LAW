        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-5xl font-serif font-bold text-emerald mb-8">
                {t("aboutus.storyTitle")}
              </h2>
              <div className="space-y-6 text-lg text-darkBrown leading-relaxed">
                <p>
                  {t("aboutus.story1")}
                </p>
                <p>
      ...
      <div className="py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-darkBrown max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {values.map((value, index) => (
              ...
              >
                <div
                  className="bg-gradient-to-br from-white to-cream border border-gold/20 rounded-2xl p-8 h-full 
                ...
                >
                  ...
                  <h3 className="text-2xl font-serif font-bold text-emerald mb-4">
                    {value.title}
                  </h3>
